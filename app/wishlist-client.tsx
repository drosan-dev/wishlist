...
const wishes: Wish[] = [
  ...
  },
  {
    ...
    details: 'Не обязательно дорогую, но проверенную: хороший экран, удобные кнопки, нормальная сборка и прошивка без постоянной возни. Заодно можно закинуть туда несколько любимых ретроигр, в которые вам хочется, чтобы я сыграл.',
    priority: 'Главное — не безымянная китайская игрушка с маркетплейса, а действительно качественная модель',
    category: 'Техника',
  },
  {
    id: 'craft-kit',
